...
const sortMeetingsByDay = (arr) => {
  let dayIndex = ['Monday','Tuesday','Wednesday','Thursday','Friday'];
  let arrIndex = arr.map(meeting => dayIndex.indexOf(meeting.dayOfWeek));
  return arr.sort((a,b) => arrIndex[arr.indexOf(a)]-arrIndex[arr.indexOf(b)]);
};
