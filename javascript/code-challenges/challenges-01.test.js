...
const addOne = (arr) => {
  let answers = [];
  arr.forEach(num => answers.push(num+1));  
  return answers;
  // Solution code here...
};
...
const addExclamation = (arr) => {
  let answer = [];
  arr.forEach( string => answer.push(`${string}!`));
  return answer;
  // Solution code here...
};
...
const allUpperCase = (arr) => {
  let answer = [];
  arr.forEach(string => answer.push(string.toUpperCase()));
  return answer;
  // Solution code here...
};
...
const speaker = (words, callback) => {
  let greetings = [];
  words.forEach(word => greetings.push(callback(word)));
  return greetings;
  // Solution code here...
};
